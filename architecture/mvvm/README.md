...
**MVVM** 是 **Model-View-ViewModel** 的简写。如果你已经对 [MVC](https://developer.apple.com/library/content/documentation/General/Conceptual/DevPedia-CocoaCore/MVC.html) 非常熟悉了，那么上手 **MVVM** 也是非常容易的。
...
这里我们将用 **MVVM** 来重构[输入验证](../../first_app.md)。

![](../../.gitbook/assets/SimpleValidationFull.gif)
...
下一节将用 [Github Signup](github_signup.md) 来演示如何使用 **MVVM**。

_注意⚠️：这里介绍的 **MVVM** 并不是严格意义上的 **MVVM**。但我们通常都管它叫 **MVVM**，而且它配合 **RxSwift** 使用起来非常方便。如需了解什么是严格意义上的 **MVVM**，请参考**微软**的_ [_The MVVM Pattern_](https://msdn.microsoft.com/en-us/library/hh848246.aspx)_。_
