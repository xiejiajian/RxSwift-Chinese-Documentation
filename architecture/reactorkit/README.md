...
![](../../.gitbook/assets/ReactorKit.png)

 ![Swift](https://img.shields.io/badge/Swift-3.1-orange.svg) [![CocoaPods](http://img.shields.io/cocoapods/v/ReactorKit.svg)](https://cocoapods.org/pods/ReactorKit) [![Platform](https://img.shields.io/cocoapods/p/ReactorKit.svg?style=flat)](https://github.com/ReactorKit/ReactorKit) [![Build Status](https://travis-ci.org/ReactorKit/ReactorKit.svg?branch=master)](https://travis-ci.org/ReactorKit/ReactorKit) [![Codecov](https://img.shields.io/codecov/c/github/ReactorKit/ReactorKit.svg)](https://codecov.io/gh/ReactorKit/ReactorKit/) [![CocoaDocs](http://reactorkit.io/docs/latest/badge.svg)](http://reactorkit.io/docs/latest/)

## 作者

[Jeon Suyeol](https://github.com/devxoul) 是 [ReactorKit](https://github.com/ReactorKit/ReactorKit) 的作者。他也发布了一些富有创造性的框架，如 [Then](https://github.com/devxoul/Then)，[URLNavigator](https://github.com/devxoul/URLNavigator)，[SwiftyImage](https://github.com/devxoul/SwiftyImage) 以及一些开源项目 [RxTodo](https://github.com/devxoul/RxTodo)，[Drrrible](https://github.com/devxoul/Drrrible)。他也是多个组织的成员 [RxSwiftCommunity](https://github.com/RxSwiftCommunity)，[Moya](https://github.com/Moya)，[SwiftKorea](https://github.com/SwiftKorea)。

## 介绍

[ReactorKit](https://github.com/ReactorKit/ReactorKit) 结合了 [Flux](https://facebook.github.io/flux/) 和[响应式编程](https://zh.wikipedia.org/wiki/响应式编程)。用户行为和页面状态都是通过序列相互传递。这些序列都是单向的：页面只能发出用户行为，然而反应器（Reactor）只能发出状态。

![](../../.gitbook/assets/BasicConcept.png)
...
每种[附加作用](../../recipes/side_effects.md)，如，异步操作，API 调用都是在这个方法内执行。
...
下一节将用 [Github Search](github_search.md) 来演示如何使用 [ReactorKit](https://github.com/ReactorKit/ReactorKit)。
