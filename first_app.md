...
* 当用户名输入不到 5 个字时显示提示语，并且无法输入密码
  ...
  ![](.gitbook/assets/UsernameValid.png)
...
* 当密码输入不到 5 个字时显示提示文字
  ...
  ![](.gitbook/assets/PasswordValid.png)
...
* 当用户名和密码都符合要求时，绿色按钮才可点击
  ...
  ![](.gitbook/assets/LoginButtonValid.png)
...
* 点击绿色按钮后，弹出一个提示框
  ...
  ![](.gitbook/assets/LoginAction.png)
...
![](.gitbook/assets/All%20%284%29.png)
...
* `share(replay: 1)` 是用来做什么的？
  ...
  我们用 `usernameValid` 来控制用户名提示语是否隐藏以及密码输入框是否可用。[shareReplay](https://github.com/xiejiajian/RxSwift-Chinese-Documentation/tree/5cbf6490bd24fb1202a38515bfa63596cbf5f06f/content/rxswift_core/operator/shareReplay.md) 就是让他们共享这一个源，而不是为他们单独创建新的源。这样可以减少不必要的开支。
